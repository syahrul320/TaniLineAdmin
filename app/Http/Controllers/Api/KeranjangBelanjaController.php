...
class KeranjangBelanjaController extends Controller
{
    public function show($id_user)
    {
        $produk = DB::table('keranjang_belanjas')
            ->select(['produks.nama_produk','produks.image', 'keranjang_belanjas.id','kategoris.nama_kategori', 'keranjang_belanjas.jumlah', 'keranjang_belanjas.keterangan', 'keranjang_belanjas.harga','keranjang_belanjas.total_harga', 'users.name as nama_merchant'])
