            ...
            <form id="form" enctype="multipart/form-data" autocomplete="off">
                <div class="card-body col-sm-6">
                    <div class="form-group has-feedback">
                        ...
                        <input type="text" id="nama_usercard" placeholder="Nama User" class="form-control" name="nama_usercard">
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <select name="id_kategori_user" id="id_kategori_user" class="form-control">
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <input type="text" id="nis_nip" placeholder="Contoh - 1809599001" class="form-control" name="nis_nip">
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <input type="text" id="email" placeholder="contoh@gmail.com" class="form-control" name="email">
                        <span class="text-danger" id="emailError"></span>
                    </div>
                    <div class="form-group has-feedback">
                        <b><label>Nomor HP</label></b>
                        <input type="text" id="nohp" placeholder="08XX-XXXX-XXXX" class="form-control" name="nohp">
        ...
        <div class="card">
            ...
            @if(Auth::user()->level==2)
                ...
                <a href="{{ route('usercard.export') }}">
                    <button type="button" class="btn btn-success px-5" id="add">
                        <i class="fadeIn animated bx bx-export"></i> Export
                    </button>
                </a>
                <a href="/usercardku/{{ encrypt($perusahaan->id) }}">
                    <button type="button" class="btn btn-dark px-5 radius-30" id="add">
...
<script src="{{  asset('assets/js/function/user_cardadmin.js') }}"></script>
@endpush
